...
class QSRlib(object):
    ...
    def request_qsrs(self, req_msg, do_median_filtering = False, filtering_window = None):
        ...
        :param do_median_filtering: Flag which signifies if a median filter will be employed on the qsr data
        :type do_median_filtering: boolean
        :param filtering_window: The size of the window used for the median filtering
        :type filtering_window: int
