...
from qsrlib_qsrs.qsr_my_abstractclass import QSR_My_Abstractclass
from qsrlib_utils.combinations_and_permutations import *
from qsrlib_io.world_qsr_trace import *


class QSR_Dyadic_Abstractclass(QSR_My_Abstractclass):
...
class QSR_Tetradic_Abstractclass(QSR_Dyadic_Abstractclass):
    ...
    def __init__(self):
        """Constructor."""
        super(QSR_Tetradic_Abstractclass, self).__init__()

    @abstractmethod
    def _compute_qsr(self, data1, data2, relation1, relation2, qsr_params, **kwargs):
        """Compute QSR value.
