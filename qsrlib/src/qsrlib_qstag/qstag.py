...
class Activity_Graph:
    ...
    def __init__(self, world, world_qsr, object_types={}, params={}):
        ...
        global spatial_obj_final_edges, temp_spatial_final_edges
        spatial_obj_final_edges, temp_spatial_final_edges = self.__spatial_obj_edges, self.__temp_spatial_edges
