...
class Object_State(object):
    ...
    def ChangeFrame(self, timeframe = None):
        """Add/Overwrite the timestamp of an object state.

        :param timeframe: The timestamp of the world state.
        :type timeframe: int or float
        """
        self.timestamp = float(timeframe)


    def get_bounding_box_centers(self):
        """Return the center coordinates of the object's bounding box.

        :return: A list of the x-axis and y-axis coordinates of the center of the
          bouding box of the object.
        """
        return [self.x , self.y]

    def negate_bounding_box_centers(self):
        """Negate the center coordinates of the object's bounding box.
    ...
    def negate_center_x(self):
        """Negate the x-axis value of the center of the object's bounding box.
    ...
    def negate_center_y(self):
        """Negate the y-axis value of the center of the object's bounding box.
    ...
    def check_negative_center_x(self):
        """Check if the x-axis coordinate of the object's bounding box is negative.

        :return: A boolean value that represents if the x-axis coordinate of the
                 object's bounding box is negative.
        """
        return self.x < 0

    def check_negative_center_y(self):
        """Check if the y-axis coordinate of the object's bounding box is negative.

        :return: A boolean value that represents if the y-axis coordinate of the
                 object's bounding box is negative.
        """
        return self.y < 0

    def check_positive_center_x(self):
        """Check if the x-axis coordinate of the object's bounding box is positive.

        :return: A boolean value that represents if the x-axis coordinate of the
                 object's bounding box is positive.
        """
        return self.x > 0

    def check_positive_center_y(self):
        """Check if the y-axis coordinate of the object's bounding box is positive.
